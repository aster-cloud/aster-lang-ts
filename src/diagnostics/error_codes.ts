...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.CALL_ARITY_MISMATCH]: "Function '{func}' expects {expected} argument(s), got {actual}.",
...
export const ERROR_METADATA: Record<ErrorCode, ErrorMetadata> = {
  ...
  [ErrorCode.DECIMAL_DOUBLE_MIXING]: {
    code: ErrorCode.DECIMAL_DOUBLE_MIXING,
    category: 'type',
    severity: 'error',
  ...
  [ErrorCode.CALL_ARITY_MISMATCH]: {
    code: ErrorCode.CALL_ARITY_MISMATCH,
    category: 'type',
    severity: 'error',
  ...
  [ErrorCode.IMPORT_SYMBOL_CONFLICT]: {
    code: ErrorCode.IMPORT_SYMBOL_CONFLICT,
    category: 'scope',
    severity: 'warning',
  ...
  [ErrorCode.EFF_INFER_UNKNOWN_BUILTIN]: {
    code: ErrorCode.EFF_INFER_UNKNOWN_BUILTIN,
    category: 'effect',
    severity: 'warning',
    message: "Effect of builtin '{builtin}' called by '{func}' is unknown; it is NOT assumed pure",
    help: "Declare it via ASTER_EFFECT_CONFIG prefixes, supply an imported effect signature, or use a known stdlib namespace.",
  },
