...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.PII_ANALYZER_FAILED]: "PII flow analysis aborted internally: {reason}. This is a bug in the type checker; PII safety cannot be guaranteed for this module — please report.",
...
export const ERROR_METADATA: Record<ErrorCode, ErrorMetadata> = {
  ...
  [ErrorCode.PII_ANALYZER_FAILED]: { code: ErrorCode.PII_ANALYZER_FAILED, category: 'pii', severity: 'error', message: "PII flow analysis aborted internally: {reason}. This is a bug in the type checker; PII safety cannot be guaranteed for this module — please report.", help: "Run typecheck via LSP server for full analysis; capture the source that triggered the abort and file an issue." },
